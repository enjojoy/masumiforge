...
function default_1(api) {
            ...
            try {
                ...
                for (let i = 0; i < 30; i++) {
                    ...
                    try {
                        ...
                        const match = agents.find((a) => a.id === registrationId ||
        ...
        async execute(_id, params) {
            ...
            try {
                ...
                const lines = agents.map((a) => {
                    ...
                    const priceStr = price ? `${(parseInt(price.amount) / 1000000).toFixed(2)} USDM` : "N/A";
        ...
        async execute(_id, params) {
            ...
            try {
                ...
                if (!sellerVkey) {
                    ...
                    const agent = (regData.data?.Assets || []).find((a) => a.agentIdentifier === params.agentIdentifier);
                    if (!agent) {
    ...
    api.registerTool({
        ...
        async execute(_id, params) {
            ...
            const fields = Array.isArray(schemaObj)
                ? schemaObj
            ...
            fields.forEach((field, i) => {
                ...
                if (!field.name)
                    errors.push(`${prefix} missing required "name"`);
                ...
                if (field.validations) {
                    if (!Array.isArray(field.validations)) {
                        ...
                        field.validations.forEach((v, vi) => {
                            if (!v.validation) {
